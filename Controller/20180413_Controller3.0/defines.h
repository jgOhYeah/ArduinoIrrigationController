#define serialSuccess 0
#define serialEnableLineLow 1
#define serialNothingToRead 2
#define serialRecieveTimedOut 3
#define serialMessageTooLong 4
#define serialChecksumNotMatch 5
